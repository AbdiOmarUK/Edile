...
<h1 class="text-center">MAIN STORE</h1>
<button><a href="allproducts.php">ALL PRODUCTS></a></button>
...
<section id="new" class="w-100">
  <div class="row p-0 m-0">
    ...
    <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
      <img class="img-fluid" src="Images/products2.jpg" />
      <div class="details">
        <h2>FOOD</h2>
        <a href="search_product.php?search_data=Food&search_data_product=Search" class="btn btn-success">Shop now</a>
      </div>
    </div>

       <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
      <img class="img-fluid" src="Images/cleaningproduct.jpg" />
      <div class="details">
        <h2>CLEANING</h2>
        <a href="search_product.php?search_data=health&search_data_product=Search" class="btn btn-success">Shop now</a>
      </div>
    </div>

       <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
      <img class="img-fluid" src="Images/drinkss.jpg" />
      <div class="details">
        <h2>DRINKS</h2>
        <a href="search_product.php?search_data=drink&search_data_product=Search" class="btn btn-success">Shop now</a>
      </div>
    </div>
...
<section id="new" class="w-100">
  <div class="row p-0 m-0">
    ...
    <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
      <img class="img-fluid" src="Images/hygiene.jpg" />
      <div class="details">
        <h2>HEALTH</h2>
       ...
       <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
      <img class="img-fluid" src="Images/sweets.jpg" />
      <div class="details">
        <h2>SWEETS, CAKES AND CHOCOLATES</h2>
        <button class="btn btn-success">Shop now</button>
      </div>
    </div>

       <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
      <img class="img-fluid" src="Images/school.jpg" />
      <div class="details">
        <h2>SCHOOL</h2>
        <button class="btn btn-success">Shop now</button>
      </div>
